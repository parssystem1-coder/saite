...
| فاز | عنوان | وضعیت |
|------|--------|--------|
| ۱ | زیرساخت و CI/CD | 🔄 در حال انجام |
| ۲ | راه‌اندازی پروژه و ساختار پایه | ⏳ در انتظار |
| ۳ | صفحات و کامپوننت‌های اصلی | ⏳ در انتظار |
| ۴ | بک‌اند و دیتابیس | ⏳ در انتظار |
| ۵ | سبد خرید و پرداخت | ⏳ در انتظار |
| ۶ | بهینه‌سازی و استقرار | ⏳ در انتظار |
