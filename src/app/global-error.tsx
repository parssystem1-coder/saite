 ...
 *
 * ⚠️ چرا اینجا رنگ‌ها hardcode هستند و نه توکن؟
 * این کامپوننت خارج از root layout رندر می‌شود، پس `globals.css`
 * و متغیرهای CSS تضمینی برای بارگذاری ندارند. اگر از
 * `hsl(var(--surface-1))` استفاده کنیم و همان CSS مشکل داشته باشد،
 * کاربر یک صفحهٔ بی‌رنگ می‌بیند. مقادیر زیر عمداً ثابت‌اند و باید با
 * توکن‌های `globals.css` هم‌خوان بمانند.
 */
