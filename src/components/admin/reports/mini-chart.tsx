 ...
 *
 * چرا SVG سفارشی: recharts/nivo چند صد کیلوبایت به باندل اضافه می‌کنند
 * و ما فقط به یک نمودار میله‌ای ساده نیاز داریم. این ۵۰ خط کار همان
 * را می‌کند بدون هزینه.
 */
