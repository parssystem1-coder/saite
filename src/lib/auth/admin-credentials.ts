 ...
 *
 * این ذاتی فاز mock است و با هیچ ترفند کلاینتی حل نمی‌شود.
 * تنها راه‌حل واقعی: جایگزینی این تابع با فراخوانی سرور.
 * تا آن زمان، پروژه را روی هاست عمومی منتشر نکنید.
 *
