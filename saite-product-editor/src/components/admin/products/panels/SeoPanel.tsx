...
export function SeoPanel({ draft, set, faqs, onFaqsChange, schema }: { draft: ProductDraft; set: <K extends keyof ProductDraft>(key: K, value: ProductDraft[K]) => void; attributes: Attribute[]; images: import('../product-editor.types').ProductImage[]; faqs: ProductFaq[]; onFaqsChange: (faqs: ProductFaq[]) => void; schema: unknown }) {
  return <>
    ...
    <EditorSection title="JSON-LD"><JsonLdPreview value={schema} /></EditorSection>
